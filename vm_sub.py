...
def on_connect(client, userdata, flags, rc):
    ...
    client.subscribe("jacho/ipinfo")
    client.subscribe("jacho/dateinfo")
    client.subscribe("jacho/timeinfo")
    
    #Add the custom callbacks by indicating the topic and the name of the callback handle
    client.message_callback_add("jacho/ipinfo", on_message_from_ipinfo)
    client.message_callback_add("jacho/dateinfo", on_message_from_dateinfo)
